...
#define ENABLE_BASE_PROCESSOR 1
#define ENABLE_ROVER_PROCESSOR 0
...
#define ENABLE_COMM_UART_DEBUG_IO 0
...
#define COMM_PORT_PRIM   INV_SOCKET_0 // not meaningful for the base
#define COMM_PORT_SECOND INV_SOCKET_1
